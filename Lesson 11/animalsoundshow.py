...
# Animal inherits from ABC - this make it an abstract class (abstraction)
class Animal(ABC):
...
class Dog(Animal):
    ...
    def __init__(self, name, habitat, breed):
        super().__init__(name, habitat)  # calls Animals constructor
        self.breed = breed
...
class Lion(Animal):
    ...
    def speak(self):
        print(f"{self.name}  (Pride:  {self.prider}) says: ROARRRRR!")
